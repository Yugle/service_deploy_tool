...
"}")
        ...
        self.submit.setGeometry(QtCore.QRect(230, 556, 151, 41))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
...
"}")
        ...
        self.restart.setGeometry(QtCore.QRect(400, 567, 21, 20))
        self.restart.setStyleSheet("border-image:url(\"../resource/img/restart.png\")")
    ...
    def retranslateUi(self, Deploy):
        ...
        self.title.setText(_translate("Deploy", "可视化诊断服务"))
        self.submit.setText(_translate("Deploy", "保存"))
