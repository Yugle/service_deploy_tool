...
from worker.threads import ConnectTransUnitThread
import re
import sys
import consts
import subprocess
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "TransUnit服务部署工具"))
        self.ssh_host.setPlaceholderText(_translate("MainWindow", "请输入IP地址"))
        ...
        # self.ssh_ip_label.setText(_translate("MainWindow", "IP地址不能为空！"))
        ...
        self.telnet_host.setPlaceholderText(_translate("MainWindow", "请输入IP地址"))
        ...
        # self.telnet_ip_label.setText(_translate("MainWindow", "IP地址不能为空！"))
        ...
        self.device_ip.setPlaceholderText(_translate("MainWindow", "请输入IP地址"))
        ...
        self.footer.setText(_translate("MainWindow", f"Copyright © 2021 {consts.COMPANY_NAME}"))
