...
"}")
        ...
        self.ssh_ip_label_2 = QtWidgets.QLabel(self.ADB)
        self.ssh_ip_label_2.setGeometry(QtCore.QRect(120, 190, 201, 21))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.ssh_ip_label_2.setFont(font)
        self.ssh_ip_label_2.setStyleSheet("color:red;")
        self.ssh_ip_label_2.setObjectName("ssh_ip_label_2")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ssh_ip_label_2.setText(_translate("MainWindow", "传输单元IP地址不能为空！"))
